...
def rotate_to_heading(current_heading, target_heading):
    ...
    while abs(target_heading - current_heading) > 5:
        ...
        motor_driver.set_left_speed((abs(target_heading - current_heading) % 25) + 40 * rotation_dir)
        motor_driver.set_right_speed((abs(target_heading - current_heading) % 25) + 40 * rotation_dir * -1)
